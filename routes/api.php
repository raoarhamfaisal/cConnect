...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/contractor/post/{contractor_id}', [PostController::class, 'gecConnectPosts'])->name('post.gecConnectPosts');
    ...
    Route::middleware('admin')->group(function () {
        Route::get('/admin/all-contractors', [ReviewController::class, 'gecConnectProfiles'])->name('review.allContractors');
