import { _ as l } from "./Avatar.00189ff3.js";
import { B as m } from "./Badge.91114060.js";
import {
  f as a,
  h as n,
  n as t,
...
const k = { class: "flex space-x-2 justify-between" },
  v = { class: "flex justify-center items-center space-x-2" },
  C = { class: "flex flex-col justify-center" },
  p = { class: "text-md xs:text-xl font-medium font-bold text-gray-900 " },
  F = { key: 0, class: "text-sm xs:text-lg" },
  S = { key: 1, class: "text-xs xs:text-lg" },
  _ = { class: "mb-3" },
  b = { class: "pl-2 text-sm xs:text-md font-bold mt-4 mb-1" },
  M = {
    __name: "ContractorInfo",
    props: ["contractor"],
    setup(e) {
      const d = [
        ...
        n(
          ...
          [
            t("div", k, [
              t("div", v, [
                t("div", null, [
                  x(l, { imageSrc: e.contractor.user_avatar }, null, 8, [
                    "imageSrc",
                  ]),
                ]),
                t("div", C, [
                  t(
                    "h2",
                    p,
                    r(e.contractor.first_name + " " + e.contractor.last_name),
                    1
                  ),
                  e.contractor.company_name
                    ? (a(), n("div", F, r(e.contractor.company_name), 1))
                    : s("", !0),
                  e.contractor.city || e.contractor.state
                    ? (a(),
                      n(
                        "span",
                        S,
                        r(e.contractor.city + " " + e.contractor.state),
                        1
                      ))
                    : s("", !0),
                ]),
