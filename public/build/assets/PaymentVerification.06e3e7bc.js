...
import { t as _ } from "./tContractorWord.ed390c35.js";
import { t as R } from "./tContractorWhite.1a9c0892.js";
import { _ as d } from "./ResponsiveNavLink.98ed2cc3.js";
import { S as k } from "./ScrollToLink.7c70f853.js";
import "./_plugin-vue_export-helper.cdc0426e.js";
const U = { class: "relative h-screen bg-white" },
  H = e(
    "img",
    {
  ...
  A = { class: "absolute top-0 left-0 right-0 z-20 bg-blue-30-rgba" },
  F = { class: "container max-w-7xl px-6 py-2 mx-auto md:px-12" },
  W = { class: "flex items-center justify-between" },
  $ = { class: "flex items-center justify-start" },
  z = { class: "flex items-center justify-end" },
  D = { key: 0 },
  E = { key: 1 },
  T = { class: "-mr-2 flex items-center" },
  I = {
    class: "h-6 w-6",
    stroke: "currentColor",
    fill: "none",
  ...
  se = e("section", null, [e("h1", null, "Verify Payments")], -1),
  oe = { class: "bg-blue-rgba" },
  re = {
    class:
  ...
  de = { class: "flex flex-col justify-between" },
  ce = { key: 0, class: "flex justify-center space-x-3" },
  ue = e(
    "span",
    {
      class:
  ...
  ke = {
    ...
    setup(i) {
      const n = p(!1);
      L({ email: "", password: "", remember: !1 });
      const v = p(null),
        j = M(() =>
          y().props.value.auth.user
            ? y().props.value.auth.user.appeals_privileges === 1
            : !1
        ),
        b = (r) => {
          v.value && !v.value.contains(r.target) && (n.value = !1);
        },
        m = () => {
          n.value = !n.value;
        };
                    ...
                    e("div", W, [
                      ...
                      e("div", z, [
                        o(
                          ...
                          { default: t(() => [l(" Why tContractor ")]), _: 1 }
                        ),
                        o(
                          u(f),
                          {
                            ...
                            c("div", E, [
                              o(
                                k,
                                {
                                  href: "#loginHere",
                                  class:
                                    "block flex justify-center items-center p-2 mx-2 px-6 font-bold rounded-xl text-white bg-blue-800 hover:bg-green-800 border-2 shadow-lg border-green-600",
                                },
                                { default: t(() => [l(" Login ")]), _: 1 }
                              ),
                            ])),
                        e("div", T, [
                          e(
                              ...
                              i.showit
                                ? (s(),
                                  c(
                                    "div",
                                    Y,
                                    w(r.$page.props.auth.user.name),
                                    1
                                  ))
                                : a("", !0),
                              i.showit
                                ? a("", !0)
                                : (s(), c("div", q, "Not Logged In")),
                            ]),
                            i.showit
                              ? (s(),
                                c(
                                  "div",
                                  K,
                                  w(r.$page.props.auth.user.email),
                                  1
                                ))
                              : a("", !0),
                          ]),
                          e("div", Q, [
                            ...
                            i.showit
                              ? (s(),
                                h(
                                  d,
                                  { key: 1, href: "/ratings/contractor" },
                                  {
                                    default: t(() => [l(" My  Ratings ")]),
                                    _: 1,
                                  }
                                ))
                              : a("", !0),
                                ...
                                : (s(),
                                  h(
                                    d,
                                    {
                                      ...
                                      onClick:
                                        g[1] ||
                                        (g[1] = (B) => (n.value = !n.value)),
                                    },
                                    { default: t(() => [l(" Log In ")]), _: 1 }
                                  )),
                            ]),
                          ]),
                        ]),
