import { H as s } from "./Header.8b20dfa0.js";
import { M as m } from "./MoveToTop.8193f768.js";
import {
  u as a,
  c as p,
  e as l,
...
import h from "./SettingsTabs.a40f17b3.js";
...
const it = {
  ...
  setup(t) {
    const i = a(),
      r = p(() => i.getters.translations),
      e = localStorage.getItem("activeTab");
    return (
      e
        ? (console.log(e, "activeTab"),
          i.commit("profile/setActiveTab", +e),
      ...
      (v, b) => (
        ...
        l(
          ...
          null,
          [
            o(c(g), { title: r.value && r.value.settings }, null, 8, ["title"]),
            o(
              s,
              {
                profile: t.profile,
