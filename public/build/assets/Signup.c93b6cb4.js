...
import { _ as d } from "./ResponsiveNavLink.9bd1f854.js";
import "./_plugin-vue_export-helper.cdc0426e.js";
const _ = { class: "relative h-screen bg-gray-200" },
  C = e(
    "img",
    {
  ...
  j = { class: "absolute top-0 left-0 right-0 z-10 bg-blue-30-rgba" },
  B = { class: "container px-6 py-2 mx-auto md:px-12" },
  L = { class: "flex items-center justify-between" },
  N = { class: "flex items-center justify-start" },
  M = { class: "flex items-baseline justify-end" },
  S = { key: 0 },
  V = { key: 1 },
  ...
  W = { class: "font-bold text-base text-gray-800 " },
  D = { key: 0 },
  H = { key: 1 },
  I = { key: 0, class: "font-medium text-sm text-gray-500" },
  P = { class: "pt-2 pb-3 space-y-1" },
  R = { class: "pt-4 pb-1 border-t-2 border-gray-400 " },
  A = { class: "mt-3 space-y-1" },
  E = {
    class: "h-6 w-6",
    stroke: "currentColor",
    fill: "none",
                    ...
                    e("div", L, [
                      ...
                      e("div", M, [
                        l(
                          ...
                          { default: s(() => [a(" Why tContractor ")]), _: 1 }
                        ),
                        l(
                          c(g),
                          {
                              ...
                              n.showit
                                ? (r(),
                                  h(
                                    "div",
                                    D,
                                    m(o.$page.props.auth.user.name),
                                    1
                                  ))
                                : i("", !0),
                              n.showit
                                ? i("", !0)
                                : (r(), h("div", H, "Not Logged In")),
                            ]),
                            n.showit
                              ? (r(),
                                h(
                                  "div",
                                  I,
                                  m(o.$page.props.auth.user.email),
                                  1
                                ))
                              : i("", !0),
                          ]),
                                ...
                                : (r(),
                                  f(
                                    d,
                                    {
                                      ...
                                      onClick:
                                        u[2] ||
                                        (u[2] = (v) => (t.value = !t.value)),
                                    },
                                    { default: s(() => [a(" Log In ")]), _: 1 },
                                    8,
                                    ["href"]
                                  )),
                            ]),
