import { _ as k } from "./AuthenticatedLayout.9f59e333.js";
import { H as F } from "./Header.8b20dfa0.js";
import { a as O, P as I, b as R } from "./PostDisplayEnlarged.adbff492.js";
import { t as D } from "./cConnectWord.60dc90ac.js";
import { B as T, _ as M } from "./filepond-plugin-file-poster.b4b2d2f1.js";
...
import { L as $ } from "./Loader.9dfd413c.js";
import { _ as z } from "./_plugin-vue_export-helper.cdc0426e.js";
...
const x = {
  ...
  Y = {
    ...
    mounted() {
      localStorage.setItem("prevUrl", "/post"),
        setTimeout(() => {
          const t = (s) => {
              s.forEach((l) => {
                l.isIntersecting && this.loadMorePosts();
              });
            },
          ...
          this.$nextTick(() => {
            this.$refs.loadMoreIntersectPosts &&
              o.observe(this.$refs.loadMoreIntersectPosts);
          });
        }, 1e3),
        this.fetchColors(),
        console.log("window.Echo", window.Echo),
        window.Echo.channel("comments")
          .listen("CommentPosted", (t) => {
            console.log("CommentPosted", t),
              this.$store.dispatch("profile/fetchCommentPosted", t);
          })
          .listen("CommentUpdated", (t) => {
            console.log("CommentUpdated:", t),
              this.$store.dispatch("profile/fetchComment", t);
          })
          .listen("CommentDeleted", (t) => {
            console.log("Comment Deleted:", t),
              this.$store.commit("profile/setPusherCommentToDelete", t.comment);
          }),
        window.Echo.channel("post").listen("PostCountersChanged", (t) => {
          console.log("data", t);
          const o = t.post;
          console.log("postContersChanged", o.repost);
          const s = this.allPosts.findIndex((l) => o.id === l.id);
          s !== -1 &&
            ((this.allPosts[s].repost = o.repost),
            (this.allPosts[s].likes_count = t.likesCount),
            (this.allPosts[s].dislikes_count = t.dislikesCount),
            (this.allPosts[s].your_reaction = t.userReaction),
            this.postDisplayEnlarged &&
              (this.postToEnlarge = this.allPosts[s]));
        }),
        window.Echo.channel("commentReactions").listen(
          "CommentReactionOrReplyChanged",
          (t) => {
            console.log("CommentReactionOrReplyChanged", t),
              this.$store.dispatch("profile/fetchComment", t);
          }
        );
    },
    props: {
      ...
      contractor_id: { type: [String, Number], required: !1 },
      showit: Boolean,
    ...
    data() {
      return {
        ...
        previousRatio: 0,
        showSpinText: !1,
        showingNavigationDropdown: p(!1),
        loadingPosts: p(!1),
        dontTakeFirstPostOnRepost: !1,
        ...
        form: x,
        postSearch: null,
        postSearch: p(this.postSearchFilters.postSearch),
        body1Colors: [
          "text-gray-900",
          "text-slate-600",
          "text-gray-600",
    ...
    computed: {
      ...
      ...m(["translations"]),
      postsToShow() {
        return this.allPosts.map((s) => ({
          ...s,
          body1: s.body1 ? s.body1.replace(/\n/g, "<br>") : s.body1,
          body2: s.body2 ? s.body2.replace(/\n/g, "<br>") : s.body2,
        }));
      },
    },
    watch: {
      updatedPostId(t) {
        t > 0 && this.getFirstPage();
      },
      deletedPost(t) {
        t && Object.keys(t).length > 0 && this.getFirstPage();
      },
      loadFirstPageWithNoPreserve(t) {
        t &&
          this.$inertia.get(
      ...
      shouldLoadPosts(t) {
        this.shouldLoadPosts &&
          (this.loadPostsOnChange(),
          this.$store.commit("ratings/setShouldLoadPosts", !1));
      },
      shouldFetchFirstPagePosts(t) {
        t &&
          this.$inertia.get(
            this.posts.first_page_url,
            {},
            {
              ...
              onSuccess: () => {
                (this.allPosts = [...this.posts.data]),
                  ...
                  this.$store.commit(
                    "ratings/setShouldFetchFirstPagePosts",
                    !1
                  );
              },
            }
    ...
    methods: {
      ...Z(["fetchUserDetails"]),
      onRepostEdit(t, o) {
        const s = this.allPosts.findIndex((l) => l.id === o);
        this.allPosts[s].repost_comment = t;
      },
      fetchColors() {
        (this.loading = !0),
          axios
            .get("/api/post/text-colors", u())
            .then(
              (t) => (
                t.data && (this.textColors = t.data.textColors),
                axios.get("/api/post/background-colors", u())
              )
            )
            .then((t) => {
              t.data && (this.backgroundColors = t.data.backgroundColors);
            })
            .catch((t) => {
              A();
            })
        ...
        this.posts.next_page_url !== null &&
          ...
          this.$inertia.get(
            ...
            {},
            {
              ...
              only: ["posts"],
              onSuccess: () => {
                this.dontTakeFirstPostOnRepost
                  ? ((this.allPosts = [
                      ...this.allPosts,
                      ...this.posts.data.slice(1),
                    ]),
                    (this.dontTakeFirstPostOnRepost = !1))
      ...
      loadPostsOnChange() {
        const t = Math.ceil((this.index + 1) / this.posts.per_page);
        this.$inertia.get(
          ...
          {},
          {
            ...
            only: ["posts"],
            onSuccess: () => {
              const o = (t - 1) * this.posts.per_page;
      ...
      onAddingEnlargeComment(t) {
        this.addedCommentInEnlarge = t;
      },
      onRespost() {
        (this.dontTakeFirstPostOnRepost = !0),
          ...
          this.$inertia.get(
            ...
            {},
            {
              ...
              onSuccess: () => {
                let t = [...this.allPosts];
                this.posts.data.forEach((o) => {
                  const s = t.findIndex((l) => l.id === o.id);
                  s > -1 ? (t[s] = o) : (t = [o, ...t]);
                }),
                  (this.allPosts = t),
                  (this.loadingPosts = !1),
  ...
  K = {
    class:
      "flex flex-col items-center justify-start mx-auto lg:mr-1 mt-3 sm:mt-6 lg:mt-0 shadow-md sm:rounded-3xl",
  },
  X = {
    class:
      "flex flex-col w-full items-center justify-start px-2 lg:max-h-screen lg:overflow-y-auto h-screen pb-8",
  },
  J = { key: 0, class: "self-start w-full mt-6 px-2" },
  Q = { class: "flex relative gap-4 mb-4 items-center" },
  tt = {
    class:
  ...
  et = { class: "font-extrabold text-2xl text-[#021d91] leading-tight" },
  ot = {
  ...
  lt = e("div", { class: "loader" }, null, -1),
  rt = e("div", { class: "px-5 text-gray-300" }, "LOADING MORE POSTS!", -1),
  nt = [lt, rt],
  at = e("div", { class: "h-5" }, null, -1),
  dt = { key: 0, class: "mt-6" },
  ht = { class: "text-white font-semibold text-2xl inline text-center" },
  pt = { key: 2 };
function ct(t, o, s, l, i, r) {
  const P = a("Head"),
    y = a("Icon"),
    w = a("Link"),
    v = a("Loader"),
    b = a("PostDisplay"),
    S = a("PostDisplayEnlarged"),
    L = a("Header");
  return (
    n(),
    d(
      ...
      null,
      [
        h(P, { title: t.translations && t.translations.news_feed }, null, 8, [
          "title",
        ]),
        h(
          L,
          {
            ...
            profile: s.profile,
            "post-search-filters": s.postSearchFilters,
            showit: s.showit,
            "show-post-buttons": !s.contractor_id,
            contentWidth: "1220px",
            color: s.contractor_id ? "#bebdbb" : "rgb(156 163 175)",
          },
          {
            default: C(() => [
              e("div", K, [
                        ...
                        e("div", Q, [
                          ...
                          e("div", tt, [
                            ...
                            e(
                              "div",
                              et,
                              _(t.translations && t.translations.my_posts),
                              1
                            ),
                          ]),
                        ]),
                    ...
                    ? (n(),
                      d(
                        ...
                        [
                                ...
                                d(
                                  ...
                                  [
                                    h(
                                      b,
                                      {
                                        onRepostEdited: r.onRepostEdit,
                                        onOnRepost: r.onRespost,
                                        addedCommentInEnlarge:
                                          i.addedCommentInEnlarge,
                                        showit: s.showit,
                                        index: E,
                                        profile: s.profile,
                                        textColors: i.textColors,
                                        backgroundColors: i.backgroundColors,
                                        post: f,
                                        body1Colors: i.body1Colors,
                                        onEnlargePost: r.EnlargePost,
                                      },
                                      null,
                                      8,
                                      [
                          ...
                          e("span", ot, null, 512),
                          W(e("div", it, nt, 512), [
                            [V, s.posts.next_page_url],
                          ]),
                          at,
                          s.posts.next_page_url === null
                            ? (n(),
                              d("div", dt, [
                                e(
                                  "div",
                                  ...
                                  _(
                                    t.translations &&
                                      t.translations.youre_all_up_to_date
                                  ) + " \u{1F973} ",
                                  1
                                ),
                              ]))
                      ...
                      d("div", pt, [
                        ...
                        q(G, { to: "body" }, [
                          h(
                            ...
                            {
                              profile: s.profile,
                              postEnlarged: i.postToEnlarge,
                              textColors: i.textColors,
                              backgroundColors: i.backgroundColors,
                              body1Colors: i.body1Colors,
                              onCloseEnlarged: r.EnLargedPostClosed,
                              onOnRepost: r.onRespost,
                              onOnAddingEnlargeComment:
                                r.onAddingEnlargeComment,
                            },
                            null,
                            8,
                            [
