...
import y from "./PaymentStep.f6afd94b.js";
import { P as w } from "./PageTitle.f25bd43b.js";
...
/* empty css                                                                  */ const k =
    { class: "flex mt-6 sm:mt-3 justify-between" },
  B = { class: "mt-10 ml-2 sm:mt-0 p-2 sm:p-3 md:p-0" },
  Y = {
    __name: "PricingPlanPage",
    props: {
      profile: Object,
      showit: Boolean,
    ...
    setup(r) {
      const d = v(),
        e = h(() => d.getters.translations),
        s = p(""),
        o = p("gold");
      return (
        _(() => {
          (s.value = localStorage.getItem("prevUrlPricingPlan")),
            (o.value = localStorage.getItem("choosedVersion")),
            console.log(o.value, "choosedVersion"),
            o.value || (o.value = "gold"),
        ...
        (U, n) => (
          ...
          V(
            ...
            null,
            [
              t(a(x), { title: e.value && e.value.pricing_plan }, null, 8, [
                "title",
              ]),
              t(
                f,
                {
                  profile: r.profile,
                  "show-post-buttons": !1,
                  "post-search-filters": r.postSearchFilters,
                  showit: r.showit,
                  color: "#f9fafb",
                },
                {
                  default: l(() => [
                    i("div", k, [
                      t(
                        ...
                        {
                          linkUrl: s.value,
                          pageTitle: e.value && e.value.pricing_plan,
                        },
                        null,
                        8,
                        ["linkUrl", "pageTitle"]
                    ...
                    i("div", B, [
                          ...
                          },
                          {
                            default: l(() => [
                              t(
                                ...
                                {
                                  default: l(() => [
                                    c(u(e.value && e.value.gold_package), 1),
                                  ]),
                                  _: 1,
                                }
                              ),
                              t(
                                ...
                                },
                                {
                                  default: l(() => [
                                    c(
                                      u(e.value && e.value.platinum_package),
                                      1
                                    ),
                                  ]),
                                  _: 1,
                      ...
                      t(
                        y,
                        {
                          region_id: r.profile.region_id,
                          choosedVersion: o.value,
                        },
                        null,
                        8,
                        ["region_id", "choosedVersion"]
                      ),
                    ]),
                  ]),
                  _: 1,
