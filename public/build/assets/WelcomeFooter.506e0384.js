...
import { t as U } from "./tContractorWord.ed390c35.js";
import { _ as c } from "./ResponsiveNavLink.98ed2cc3.js";
import { t as A } from "./tContractorWhite.1a9c0892.js";
const S = {
  ...
  R = { class: "container max-w-7xl px-6 py-2 mx-auto md:px-12" },
  ...
  J = { class: "font-bold text-base text-gray-800" },
  Y = { key: 0 },
  q = { key: 1 },
  K = { key: 0, class: "font-medium text-sm text-gray-500" },
  Q = { class: "pt-2 pb-3 space-y-1" },
  X = { class: "pb-1 border-t-2 border-gray-400" },
  ...
  we = {
    ...
    setup(r) {
      const n = b(!1),
        ...
        w = (s) => {
          x.value && !x.value.contains(s.target) && (n.value = !1);
        },
        y = () => {
          n.value = !n.value;
        };
                ...
                e("div", E, [
                  a(
                    f(h),
                    {
                      onClick:
                        u[0] ||
                        (u[0] = (v) => s.$inertia.visit("/#whytContractor")),
                      class:
                    ...
                    ? (o(),
                      d("div", I, [
                        a(
                          ...
                          {
                            href:
                              s.profile && s.profile.is_payment_verified
                                ? s.route("post")
                                : "/profile-setup",
                            class:
                      ...
                      d("div", z, [
                        a(
                          f(h),
                          {
                            onClick:
                              u[1] ||
                              (u[1] = (v) => s.$inertia.visit("/#loginHere")),
                            class:
                  ...
                  e("div", O, [
                    e("div", G, [
                      e("div", J, [
                        r.showit
                          ? (o(),
                            d("div", Y, C(s.$page.props.auth.user.name), 1))
                          : l("", !0),
                        r.showit
                          ? l("", !0)
                          : (o(), d("div", q, "Not Logged In")),
                      ]),
                      r.showit
                        ? (o(),
                          d("div", K, C(s.$page.props.auth.user.email), 1))
                        : l("", !0),
                    ]),
                    e("div", Q, [
                      a(
                        c,
                        {
                          onClick:
                            u[2] ||
                            (u[2] = (v) =>
                              s.$inertia.visit("/#whytContractor")),
                        },
                        { default: t(() => [i(" Why "), a(U)]), _: 1 }
                      ),
                      r.showit
                        ? (o(),
                          g(
