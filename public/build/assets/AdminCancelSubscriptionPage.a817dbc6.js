import { H as U } from "./Header.8b20dfa0.js";
import {
  u as V,
  D as E,
  r as i,
...
/* empty css                                                               */ import { _ as J } from "./_plugin-vue_export-helper.cdc0426e.js";
import "./iconify.99e09ef6.js";
import "./SelectProfile.a00d96e3.js";
import { C as Q } from "./CustomDialog.f5ff7c4f.js";
import { C as Y } from "./Card.0c51827f.js";
import { P as q } from "./PageTitle.f25bd43b.js";
...
/* empty css                                                             */ /* empty css                                                                  */ const n =
    (s) => (Z("data-v-410ea2cd"), (s = s()), G(), s),
  tt = { class: "bg-gray-200 mt-2 flex-col" },
  ot = { class: "flex justify-between" },
  et = n(() =>
    o(
      "div",
  ...
  at = { class: "flex flex-col mt-2" },
  nt = { class: "font-bold bg-black" },
  st = n(() =>
    o(
      "th",
      {
  ...
  mt = { class: "flex gap-2 justify-center items-center" },
  _t = ["onClick"],
  gt = ["onClick"],
  ft = { class: "w-full" },
  ut = {
  ...
  vt = {
    __name: "AdminCancelSubscriptionPage",
    props: {
      profile: Object,
      showit: Boolean,
    ...
    setup(s) {
      const v = V(),
        w = E().props.value.auth.user.payments_privileges,
        r = i([]),
        p = i(!1),
        x = i(null),
        h = i(!1);
      ...
      const P = k(() => v.getters.screenWidth),
        m = k(() => v.getters.translations),
        y = async () => {
          try {
            const e = await A.get("/api/admin/cancellation-requests", D());
            console.log(e, "response"), e.data && (r.value = [...e.data]);
          } catch {
            R();
          }
        },
        W = (e) => {
          (x.value = e), f.value.openDialog();
        },
        T = async () => {
          h.value = !0;
          try {
            const e = await A.post(
              `/api/admin/accept-cancellation/${x.value}`,
              {},
              D()
            );
            e.data &&
              (X(e.data.message || "Cancel request successfully accepted"),
              setTimeout(() => {
                y();
              }, 2e3));
          } catch (e) {
            console.log(e), R(e.response.data.message, "inherit");
          }
          (h.value = !1), f.value.closeDialog();
        };
      return (e, wt) => {
        const $ = j("v-table"),
          F = j("v-skeleton-loader");
        return (
          l(),
          _(
            I,
            null,
            [
              c(d(z), { title: "Cancel Subscription Requests" }),
              d(w)
                ? (l(),
                  B(
                    U,
  ...
  zt = J(vt, [["__scopeId", "data-v-410ea2cd"]]);
