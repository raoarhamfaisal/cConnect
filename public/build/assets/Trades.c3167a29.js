...
import { _ as C } from "./PrimaryButton.bb59afa8.js";
const F = a(
    "header",
  ...
  S = { class: "grid mt-8 gap-3" },
  T = ["for"],
  D = ["onClick"],
  M = { class: "flex items-center gap-4 mt-10" },
  V = { key: 0, class: "text-sm text-gray-600 " },
  j = {
    __name: "Trades",
    ...
    setup(f) {
      const e = f,
        r = h({
          trade1: e.profile.trade1,
          trade2: e.profile.trade2,
          trade3: e.profile.trade3,
          trade4: e.profile.trade4,
          trade5: e.profile.trade5,
          trade6: e.profile.trade6,
          trade7: e.profile.trade7,
          trade8: e.profile.trade8,
          trade9: e.profile.trade9,
          trade10: e.profile.trade10,
          trade11: e.profile.trade11,
          trade12: e.profile.trade12,
          trade13: e.profile.trade13,
          trade14: e.profile.trade14,
          trade15: e.profile.trade15,
          trade16: e.profile.trade16,
          trade17: e.profile.trade17,
          trade18: e.profile.trade18,
          trade19: e.profile.trade19,
          trade20: e.profile.trade20,
          trade21: e.profile.trade21,
          trade22: e.profile.trade22,
          trade23: e.profile.trade23,
          trade24: e.profile.trade24,
        }),
        p = [
          ...
          a(
            "form",
            {
              onSubmit:
                n[0] ||
                (n[0] = b(
                  (t) => d(r).patch(i.route("profile.updateTrades")),
                  ["prevent"]
                )),
            },
            [
