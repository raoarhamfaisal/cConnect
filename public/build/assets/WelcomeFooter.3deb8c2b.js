...
import { t as L } from "./tContractorWord.c6273121.js";
import { _ as c } from "./ResponsiveNavLink.3ddc0b9c.js";
import { t as A } from "./tContractorWhite.c6cdd9b7.js";
const S = {
  ...
  R = { class: "container max-w-7xl pr-6 pl-4 sm:px-6 py-2 mx-auto md:px-12" },
  V = { class: "flex items-center justify-between" },
  H = { class: "flex items-center justify-start" },
  W = e(
    "span",
  ...
  P = e("span", { class: "text-white font-bold font-sans" }, "ontractor", -1),
  E = { class: "flex items-center justify-end" },
  I = { key: 0 },
  z = { key: 1 },
  D = { class: "-mr-4 sm:-mr-2 flex items-center" },
  T = {
    class: "h-6 w-6",
    stroke: "currentColor",
    fill: "none",
  ...
  O = { class: "" },
  G = { class: "pt-4 pb-2 pl-3 border-b-2 border-gray-400" },
  q = { class: "font-bold text-base text-gray-800" },
  J = { key: 0 },
  K = { key: 1 },
  Q = { key: 0, class: "font-medium text-sm text-gray-500" },
  X = { class: "pt-2 pb-3 space-y-1" },
  Y = { class: "pb-1 border-t-2 border-gray-400" },
  Z = { class: "mt-3 space-y-1" },
  ee = {
    key: 2,
  ...
  we = {
    ...
    setup(o) {
      const n = b(!1),
        ...
        m = b(!1),
        B = M(() =>
          k().props.value.auth.user
            ? k().props.value.auth.user.appeals_privileges === 1
            : !1
        ),
        w = (r) => {
          x.value && !x.value.contains(r.target) && (n.value = !1);
        },
        y = () => {
          n.value = !n.value;
        };
      return (
        U(() => {
          _() && (console.log(_(), m.value, "token"), (m.value = !0)),
                ...
                e("div", E, [
                  a(
                    f(h),
                    {
                      onClick:
                        u[0] ||
                        (u[0] = (p) => r.$inertia.visit("/#whytContractor")),
                      class:
                    ...
                    { default: t(() => [i(" Why tContractor ")]), _: 1 }
                  ),
                  o.showit && o.showNewsFeed
                    ? (s(),
                      d("div", I, [
                        a(
                          f(h),
                          {
                            href:
                              r.profile &&
                              r.profile.is_payment_verified &&
                              r.profile.active_user
                                ? r.route("post")
                                : "/profile-setup",
                            class:
                      ...
                      d("div", z, [
                        a(
                          f(h),
                          {
                            onClick:
                              u[1] ||
                              (u[1] = (p) => r.$inertia.visit("/#loginHere")),
                            class:
                  ...
                  e("div", O, [
                    e("div", G, [
                      e("div", q, [
                        o.showit
                          ? (s(),
                            d("div", J, C(r.$page.props.auth.user.name), 1))
                          : l("", !0),
                        o.showit
                          ? l("", !0)
                          : (s(), d("div", K, "Not Logged In")),
                      ]),
                      o.showit
                        ? (s(),
                          d("div", Q, C(r.$page.props.auth.user.email), 1))
                        : l("", !0),
                    ]),
                    e("div", X, [
                      a(
                        c,
                        {
                          onClick:
                            u[2] ||
                            (u[2] = (p) =>
                              r.$inertia.visit("/#whytContractor")),
                        },
                        { default: t(() => [i(" Why "), a(L)]), _: 1 }
                      ),
                      o.showit
                        ? (s(),
                          g(
                            c,
                            { key: 0, href: "/ratings/contractor" },
                            { default: t(() => [i(" My Ratings ")]), _: 1 }
                          ))
                        : l("", !0),
                    ]),
                    e("div", Y, [
                      e("div", Z, [
                          ...
                          ? (s(),
                            g(
                              c,
                              {
                                ...
                                as: "button",
                                onClick:
                                  u[3] || (u[3] = (p) => (n.value = !n.value)),
                              },
                              { default: t(() => [i(" Log Out ")]), _: 1 },
                              8,
                              ["href"]
                            ))
                          : l("", !0),
                        !o.showit &&
                        o.showSignUp &&
                        (f($.Inertia).page.component != "Auth/Register" ||
                          f($.Inertia).page.component != "Auth/VerifyEmail")
                          ? (s(),
                            g(
                              c,
                              {
                            ...
                            g(
                              c,
                              {
                                ...
                                onClick:
                                  u[4] ||
                                  (u[4] = (p) =>
                                    r.$inertia.visit("/#loginHere")),
                                as: "button",
                              },
                              { default: t(() => [i(" Log In ")]), _: 1 }
                            )),
                      ]),
                    ]),
                  ]),
  ...
  le = { class: "flex flex-col justify-between" },
  de = { key: 0, class: "flex justify-center space-x-3" },
  ce = e(
    "span",
    {
      class:
  ...
  fe = { key: 1, class: "flex justify-center space-x-3" },
  he = e(
    "span",
    {
      class:
