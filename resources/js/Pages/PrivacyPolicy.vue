...
<template>
  <SignUpLayout>
    ...
    <div class="mb-3 sm:mb-6">
      <Link href="/" class="text-blue-500 hover:underline">← Back to Main Page</Link>
    </div>
    ...
    <section class="mb-6 closing">
      ...
      <p class="mb-2">
      <ul>
        <li><strong>Personal Information:</strong> Such as names, email addresses, phone numbers, and physical addresses
    ...
    <section class="mb-6 closing">
      ...
      <p class="mb-2">
      <ul>
        <li><strong>Provide, Maintain, and Improve Our Services:</strong> We use your personal information to manage your
        ...
        <li><strong>Security:</strong> We use information about you to verify accounts and activity, and to promote safety
          and security on and off our platform.</li>
      </ul>
      </p>
    </section>
    <section class="mb-6 closing">
      <h2 class="text-xl font-semibold mb-2">Sharing Your Information</h2>
      <p class="mb-2">We do not share your personal information with third parties without your consent, except in the
        following circumstances:
      <ul>
        <li><strong>Legal Compliance:</strong> We may disclose your information to comply with applicable legal and
          regulatory obligations, such as responding to subpoenas or other governmental requests.</li>
        <li><strong>Service Providers:</strong> We may employ third-party companies and individuals to facilitate our
