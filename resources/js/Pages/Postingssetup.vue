...
onMounted(() => {
    ...
    const observer = new IntersectionObserver(
        entries => entries.forEach(entry => entry.isIntersecting && loadMorePosts(), {
...
function myStickyFunction(showingNavigationDropdown) {
    let headerSticky = document
        .getElementById("myHeader");
    let hamburgerSticky = document
        .getElementById("hamburgerwithsticky");
