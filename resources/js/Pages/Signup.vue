...
<div class="relative h-screen bg-gray-200">
    <img src="images/pages/bg_a_xl.jpg" class="absolute object-cover w-full h-full" />
    ...
    <nav class="container px-6 py-2 mx-auto md:px-12">
        <div class="flex items-center justify-between ">
            ...
            <div class="flex items-baseline justify-end">
                ...
                <!-- Login Button -->
                <div v-if="!showit">
                    <Link :href="route('post')" class="block
                                                mt-3 mr-2
                                                p-3 px-6 pt-2
                                                font-bold rounded-xl
                                                text-white
            ...
            <div class="">
                ...
                <div class="pt-4 pb-1 border-t-2 border-gray-400 dark:border-gray-600">
                    <div class="mt-3 space-y-1">
                        ...
                        <ResponsiveNavLink v-if="!showit" :href="route('logout')" method="post"
                                            as="button"
