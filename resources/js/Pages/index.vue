...
<div class="relative h-screen bg-white">
    <!-- bg-gray-200 -->
    <img src="images/pages/bg_a_xl_white.jpg" class="absolute object-cover w-full h-full" />
    ...
    <nav class="container max-w-7xl px-6 py-2 mx-auto md:px-12">
        <div class="flex items-center justify-between ">
            ...
            <div class="flex items-baseline justify-end">
                ...
                <ScrollToLinkVue href="#whytContractor"
                                 class="hidden md:block
                                        mx-3
                                        text-lg font-bold
                                        text-white hover:text-blue-rgba
                                        cursor-pointer
                                        hover:underline
                ...
                <div v-if="!showit">
                    ...
                    <ScrollToLinkVue href="#loginHere"
                                    class="block
                                            mt-3 mr-2
                                            p-3 px-6 pt-2
                                            font-bold rounded-xl
        ...
        'hidden': ! showingNavigationDropdown}"
                class="absolute top-16
                        right-4 sm:right-6 lg:right-20 xl:right-32 2xl:right-80
                        z-30
                        px-3
                        text-left
                        border-b border-gray-400 rounded-xl
            ...
            <div class="">
                ...
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink v-if="showit" :href="route('post')" :active="route().current('post')"
                        class="font-bold">
                        News Feed
                    </ResponsiveNavLink>
                ...
                <div class="pt-4 pb-1 border-t-2 border-gray-400 dark:border-gray-600">
                    <div class="mt-3 space-y-1">
                        ...
                        <ResponsiveNavLink v-if="showit" :href="route('logout')" method="post" as="button"
                            @click="showingNavigationDropdown = ! showingNavigationDropdown">
                            Log Out
                        </ResponsiveNavLink>
                        <ResponsiveNavLink v-if="!showit" :href="route('signup')"
                                            as="button"
                                            class="text-blue-rgba font-bold">
                            Sign Up
                        </ResponsiveNavLink>
                        <ResponsiveNavLink v-if="!showit" href="#loginHere"
                                           as="button"
                            @click="showingNavigationDropdown = ! showingNavigationDropdown">
                            Log In
                        </ResponsiveNavLink>
            ...
            <button @click="showingNavigationDropdown = ! showingNavigationDropdown"
                    class="inline-flex items-start justify-center p-2 rounded-md
                            text-black dark:text-white hover:text-gray-500 dark:hover:text-gray-400
                            hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400
...
<section>
    <div class="container relative
        ...
        <div class="relative z-10 flex flex-col items-start
                    ...
                    md:w-3/5
                    xl:w-2/5
                  bg-blue-30-rgba rounded-xl
                    border border-blue-rgba shadow-lg
                    p-2 py-4 px-4
                    ">
            ...
            <h1 class="mt-4
                    ...
                    sm:text-5xl
                    font-bold
                    text-white tracking-tighter capitalize ">
                    Want access to the most powerful tool in construction?
            </h1>

            <Link class="group flex items-center justify-between
                        rounded-xl border border-red-500
                        bg-red-500 px-5 py-3 mt-8 transition-colors
                        hover:bg-red-800 focus:outline-none focus:ring"
                :href="route('signup')">
...
<section class="relative">
    ...
    <div class="container
        ...
        <div v-if="showit"
            class="max-w-lg">
            <h2 class="text-3xl font-bold sm:text-4xl">Why Do You need
                <br />
                <span class="text-center text-4xl sm:text-6xl"><tContractorWord /> ?</span>
            </h2>
            ...
            <p class="mt-4
                ...
                From Searching for Locally Vetted Sub-Contractors, to
                Finding Jobs, Getting Bids... <br />to Free Advertising.
            </p>
        ...
        <div v-if="!showit"
             ...
             class="
                ...
                <div class="flex flex-col flex-shrink-0
                        ...
                        <h2 class="text-3xl
                                   font-bold
                                   sm:text-4xl md:max-lg:text-3xl">Why Do You need
                            <br />
                ...
                <div class="flex flex-col flex-shrink-0
                    ...
                    <div class="mx-auto pt-0">
                        <p class="text-green-800
                                    ...
                                    font-bold pb-2
                                    text-xl">
                            Login in to Join The Private Community
...
<div class="">
    <div class="container flex flex-col-reverse md:flex-row
            ...
            <div class="flex flex-col space-y-2 pt-6 md:pt-0
                        px-4 md:px-0">
                <div class="">
                    <Link href="/" class="text-5xl md:text-6xl
                                          font-bold tracking-wide text-center">
                            <tContractorWhite />
                    </Link>
                </div>
                <div>
                    <ul class="capitalize text-xl font-semibold
                                tracking-tighter list-disc">
                        ...
                        <li class="lg:max-w-md"><span class="font-bold italic">"No-Brainer Pricing"</span>
                            &nbsp;- As contractors ourselves, seems like everyone is
                            trying to sell us something at super - exorbitant prices!
                        <span class="font-extrabold text-white normal-case">&nbsp;Not Here at&nbsp; <tContractorWhite /></span>&nbsp;... useful tools, decently priced!</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="flex flex-row justify-center">
                        <div class="flex text-5xl justify-start font-extrabold text-green-rgba">
                            <span class="pt-10">$</span>
                        </div>
                        <div class="price">
                            <span>29</span>
                        </div>
                        <div class="flex text-xl justify-end items-end italic text-blue-rgba pb-10">
                            <span>/month</span>
                        </div>
                ...
                <div class="flex justify-center items-end">
                    <Link :href="route('signup')"
                          class="p-3 px-6 pt-2 text-red
                            bg-white rounded-lg border-white border-spacing-3
                            shadow-2xl shadow-black align-baseline
                            hover:text-white
                            hover:bg-blue-30-rgba">Get Started
                    </Link>
                </div>
            </div>
    </div>
                    ...
                    <Link class="group flex items-center justify-between
                          ...
                          >
                            ...
                            <span class="ml-4 flex-shrink-0
                                        ...
                                        bg-white p-2 text-indigo-600 group-active:text-indigo-500
                                        ">
                                <svg class="h-5 w-5"
                ...
                <div v-if="showit" class="flex justify-center space-x-3">
                    <Link :href="route('post')"
                          class="group flex items-center
                                justify-between
                                rounded-xl border border-green-600 bg-green-600
                                hover:bg-green-800
                                px-5 py-3 mt-8 transition-colors
                    ...
                    <!-- Arrow -->
                    <span class="ml-4 flex-shrink-0 rounded-full border
                                 border-current bg-white p-2
                                 text-indigo-600 group-active:text-indigo-500
                                 ">
                        <svg class="h-5 w-5"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 24 24"
