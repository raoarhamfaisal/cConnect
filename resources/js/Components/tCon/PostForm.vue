...
<template>
    <div v-if="isOpen"
        ...
        <div class="flex items-start justify-start
                    min-h-screen mt-5 pt-4 px-1  pb-20
        ...
        <div class="">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="formPostTitle" placeholder="Post Title...">
                <div v-if="$page.props.errors.title"
                        class="text-red-500">{{ $page.props.errors.title }}
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    class=" w-full py-2 px-3
                            ...
                            placeholder:italic placeholder:text-slate-500
                            dark:placeholder:text-gray-300"
                    id="formPostbody1" placeholder="Top text...">
                <div v-if="$page.props.errors.body1"
                        class="text-red-500">{{ $page.props.errors.body1 }}
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    class=" w-full py-2 px-3
                            ...
                            placeholder:italic placeholder:text-slate-500
                            dark:placeholder:text-gray-300"
                    id="formPostbody2" placeholder="Bottom text...">
                <div v-if="$page.props.errors.body2"
                        class="text-red-500">{{ $page.props.errors.body2 }}
                </div>
            </div>
                    ...
                    <div class="bg-gray-50 px-4 py-3
                        ...
                        <span class="flex w-full
                            ...
                            <button type="button"
                                    ...
                                    border border-transparent px-4 py-2 bg-green-600
                                    text-base leading-6 font-medium text-white shadow-sm
                                    hover:bg-green-500 focus:outline-none f
                                    ocus:border-green-700 focus:shadow-outline-green
                                    transition ease-in-out duration-150
                                    sm:text-sm sm:leading-5">
                                Update Post
                            </button>
                        ...
                        <span class="mt-3 flex w-full
                            ...
                            <button type="button"
                                    ...
                                    class="inline-flex justify-center w-full rounded-md
                                    border border-gray-300 px-4 py-2 bg-white
                                    text-base leading-6 font-medium text-gray-700
                        ...
                        <span class="mt-3 flex w-full
                            ...
                            <button type="button"
                                    ...
                                    leading-6 font-medium text-gray-700 shadow-sm
