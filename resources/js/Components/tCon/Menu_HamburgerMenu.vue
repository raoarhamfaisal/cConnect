    ...
    <div    id="hamburgerwithsticky"
            ...
            <div
                    ...
                    class="
                            ...
                            top-16
                            right-4 sm:right-6
                            lg:right-20 xl:right-32 2xl:right-80
                            z-20
                            px-3
                            text-left
...
<div class="relative mt-1">
          ...
          <div class="mb-0 xl:w-96">
            <div class="relative mb-2 flex w-full flex-wrap
                ...
                <input
                    ...
                    class=" relative m-0 -mr-px block w-[1%] min-w-0
                            flex-auto
                            bg-clip-padding px-3 py-1.5 text-base
                            font-normal text-gray-700 outline-none
                            rounded-l-md border border-solid
                            border-gray-600
                            dark:text-gray-300
                ...
                <button
                    ...
                    class=" relative z-[2] flex items-center
                            ...
                            rounded-r-md border border-solid
                            border-gray-600
    ...
    <!-- +++++++++++++++++++++++++++++++++++++++ -->
                            ...
                            <!-- DropDown: NEWS FEED -->
                            <Link   v-if="Inertia.page.component != 'Postings'"
                                    :href="route('post')"
                                    class="flex items-center px-4 py-1
                                            text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-300
                            ...
                            <Link :href="route('post')"
                                    class="flex items-center px-4 py-1
                                            text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-300
                                            dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                                    <img src="images/icons/contractorpage_b.png" width="20" height="20" />
                                    <span class="mx-4 font-medium">Contractor page</span>
                            </Link>


                            <div class="pt-1 border-t-2
                    ...
                    <button @click="NavigationDropdown"
                        class="inline-flex items-start justify-center p-2
                                    rounded-md
            ...
            </div> <!-- END: HAMBURGER Navigation Menu -->
    </div>
</template>
