...
<div class="fixed z-40 inset-0
    ...
    <div class="relative
        ...
        <div class="inline-block align-bottom bg-white rounded-lg
            ...
            <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
            <div class="bg-slate-200 px-2 mb-2 p-0 border-b-2 border-b-gray-400 w-full ">
                <button class="w-full"
                        @click="$emit('close-enlarged')">
                    <div class="flex flex-row items-center justify-between w-full pt-1 pb-1">
                        <div class="flex items-center justify-start gap-2">
                            <Icon icon="ph:arrow-fat-left-duotone" color="#232069" height="35" />
            ...
            <!-- Text Body1 UPPER -->
            <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
            <div v-show="postToEnlarge.body1" class="flex flex-row justify-center items-center
                                w-full
                                px-2
                                text-lg
                                xs:text-xl
                                md:text-2xl
                                dark:text-gray-300"
                :class="[body1Colors[postToEnlarge.body1ColorId],
