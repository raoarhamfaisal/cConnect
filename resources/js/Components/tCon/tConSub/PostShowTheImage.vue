...
function image_path(img) {      // function adds the filepath
    return '/uploads/posts/' + img;
};

function isVideo(img) {                 // determine if video
...
<template>
    <div>
                ...
                <video
                        ...
                        <source :src="image_path(props.image)"
                        type="video/mp4" />
                </video>
                ...
                <div    v-else>
                        ...
                        <img v-if="cropImage"
                            class=" h-full
                                    ...
                                    rounded-lg
                                    "
                            :src="image_path(props.image)" alt=""
                        >
                        <img v-else
                            class=" w-full h-full
                                    object-fill
